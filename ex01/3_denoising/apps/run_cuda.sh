...
/usr/local/cuda/bin/nvcc denoising.cu -w `pkg-config opencv4 --cflags --libs` cu01_3.cpp calc_covariance.cpp -o apps/denoising_cuda
./apps/denoising_cuda $1 $2 $3 $4 $5